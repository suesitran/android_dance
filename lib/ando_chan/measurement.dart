...
class AndoChanMeasurement {
  ...
  leftArm = ArmMeasurement(width: width, height: height, alignment: LimbAlignment.left),
  rightArm = ArmMeasurement(width: width, height: height, alignment: LimbAlignment.right),
  leftLeg = LegMeasurement(width: width, height: height, alignment: LimbAlignment.left),
  rightLeg = LegMeasurement(width: width, height: height, alignment: LimbAlignment.right),
...
class FaceMeasurement {
  ...
  FaceMeasurement({required double width, required double height}) : size = min(width, height)/3;
}

class LimbMeasurement {
  final LimbAlignment alignment;
  LimbMeasurement({required double width, required double height, required this.alignment});
}
...
class ArmMeasurement extends LimbMeasurement {
  ...
  final double height;
  final double radius;
  ArmMeasurement({required super.width, required super.height, required super.alignment}) :
...
class LegMeasurement extends LimbMeasurement {
  ...
  LegMeasurement({required super.width, required super.height, required super.alignment}):
  width = min(width, height) / 12,
